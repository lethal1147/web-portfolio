...
const projects: project[] = [
    { id: 1, img: '/project-orangecat.png', name: "Orange Cat", description: "My final project at Generation bootcamp was an exercise tracking web-application", repo: 'https://github.com/JSD4-Orangecat/Activity_Tracking', demo: 'https://orangecat.vercel.app/' },
